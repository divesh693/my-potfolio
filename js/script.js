...
const projects = [
    {
        id: 1,
        title: 'Weather App',
        description: 'An interactive web-based platform that allows users to generate unique digital artwork using cutting-edge AI models such as DALL·E or Stable Diffusion. The application transforms user-submitted text prompts into high-quality images in real time.',
        technologies: ['Frontend: React.js Tailwind CSS',
...
const titles = [
    "Hi, I'm Divesh Pandey, Junior Web Developer",
    "Hi, I'm Divesh Pandey, Software Development Trainee"
];
